...
export function ContactSection() {
  ...
  return (
    <Reveal>
      ...
      >
        <ThemeShiftBackdrop />
        <div className="relative z-10 grid gap-6 xl:grid-cols-[0.78fr_1.22fr] xl:items-start">
          <div className="grid gap-4">
            <div
              ...
              style={{
                ...
                background:
                  theme === 'light'
                    ? 'linear-gradient(160deg, rgba(247,252,255,0.98), rgba(231,244,255,0.94), rgba(242,249,255,0.96))'
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  <div className="inline-flex items-center gap-3 rounded-full border px-4 py-2 text-sm font-semibold text-[var(--color-text)]">
                  ...
                  >
                    Frontend + mobile + backend + AI workflow
                  </div>
                </div>
